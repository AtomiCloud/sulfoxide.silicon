...
|-----|------|---------|-------------|
| apps | object | `{"container-logs":{"collector":"container-logs.yaml","spec":{"env":[{"name":"KUBE_NODE_NAME","valueFrom":{"fieldRef":{"fieldPath":"spec.nodeName"}}}],"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"daemonset","podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"container-logs-collector"},"podSecurityContext":{"runAsNonRoot":false},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"resources":{"limits":{"cpu":1,"memory":"1Gi"},"requests":{"cpu":"250m","memory":"256Mi"}},"securityContext":{},"volumeMounts":[{"mountPath":"/var/log/pods","name":"varlogpods","readOnly":true},{"mountPath":"/var/lib/docker/containers","name":"varlibdockercontainers","readOnly":true}],"volumes":[{"hostPath":{"path":"/var/log/pods"},"name":"varlogpods"},{"hostPath":{"path":"/var/lib/docker/containers"},"name":"varlibdockercontainers"}]}},"k8s-cluster":{"collector":"k8s-cluster.yaml","spec":{"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"deployment","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"cluster-metrics-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"replicas":1,"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"50m","memory":"256Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"serviceAccount":"otel-collector-k8scluster-sa"}},"k8s-events":{"collector":"k8s-events.yaml","spec":{"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"deployment","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"cluster-events-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"replicas":1,"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"50m","memory":"256Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"serviceAccount":"otel-collector-k8sevents-sa"}},"kubelet-stats":{"collector":"kubelet-stats.yaml","spec":{"env":[{"name":"K8S_NODE_NAME","valueFrom":{"fieldRef":{"fieldPath":"spec.nodeName"}}},{"name":"KUBE_NODE_NAME","valueFrom":{"fieldRef":{"fieldPath":"spec.nodeName"}}}],"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"daemonset","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"kubelet-stats-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"50m","memory":"128Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"serviceAccount":"otel-collector-kubelet-sa"}},"otlp":{"collector":"otlp.yaml","spec":{"env":[{"name":"KUBE_NODE_NAME","valueFrom":{"fieldRef":{"fieldPath":"spec.nodeName"}}}],"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"daemonset","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"otlp-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"50m","memory":"128Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}}}},"otlp-logs":{"collector":"otlp-logs.yaml","spec":{"env":[{"name":"KUBE_NODE_NAME","valueFrom":{"fieldRef":{"fieldPath":"spec.nodeName"}}}],"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"daemonset","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"otlp-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"ports":[{"name":"zpages","port":55679,"targetPort":55679}],"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"50m","memory":"128Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}}}},"target-allocator":{"collector":"ta.yaml","spec":{"envFrom":[{"secretRef":{"name":"grafana-cloud-secrets"}},{"configMapRef":{"name":"otel-common-config-map"}}],"mode":"statefulset","nodeSelector":{},"podAnnotations":{"<<":{"argocd.argoproj.io/compare-options":"IgnoreExtraneous","atomi.cloud/layer":"1","atomi.cloud/platform":"sulfoxide","atomi.cloud/service":"silicon"},"atomi.cloud/module":"target-allocator-collector"},"podSecurityContext":{"<<":{"fsGroup":1000,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"replicas":1,"resources":{"limits":{"cpu":"250m","memory":"1Gi"},"requests":{"cpu":"100m","memory":"256Mi"}},"securityContext":{"<<":{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"readOnlyRootFilesystem":true,"runAsGroup":1000,"runAsNonRoot":true,"runAsUser":1000}},"targetAllocator":{"enabled":true,"prometheusCR":{"enabled":true},"serviceAccount":"otel-collector-ta-sa"}}}}` | Dictionary of collectors to deploy. Key is the name of the collector, while the value is the configuration for the collector. This has 2 sub keys: `collector` which is the actual [collector configuration](https://opentelemetry.io/docs/collector/configuration/), and `spec`, which is the [operator's configuration](https://github.com/open-telemetry/opentelemetry-operator/blob/main/docs/api.md#opentelemetrycollectorspec) for the collector. |
| auth | object | `{"external":{"enable":true,"policy":{"creation":"Owner","deletion":"Retain"},"secretStore":{"kind":"SecretStore","name":"doppler"}},"internal":{"enable":false,"loki":{"password":"","user":""},"mimir":{"password":"","user":""},"tempo":{"password":"","user":""}},"loki":{"password":{"local":"LOKI_PASSWORD","remote":"LOKI_PASSWORD"},"user":{"local":"LOKI_USER","remote":"LOKI_USER"}},"mimir":{"password":{"local":"MIMIR_PASSWORD","remote":"MIMIR_PASSWORD"},"user":{"local":"MIMIR_USER","remote":"MIMIR_USER"}},"secretName":"grafana-cloud-secrets","tempo":{"password":{"local":"TEMPO_PASSWORD","remote":"TEMPO_PASSWORD"},"user":{"local":"TEMPO_USER","remote":"TEMPO_USER"}}}` | Auth configuration for the collectors |
...
| auth.loki | object | `{"password":{"local":"LOKI_PASSWORD","remote":"LOKI_PASSWORD"},"user":{"local":"LOKI_USER","remote":"LOKI_USER"}}` | Loki auth configuration |
| auth.loki.password | object | `{"local":"LOKI_PASSWORD","remote":"LOKI_PASSWORD"}` | Password for Loki |
| auth.loki.password.local | string | `"LOKI_PASSWORD"` | Local Key reference |
| auth.loki.password.remote | string | `"LOKI_PASSWORD"` | Remote Key reference |
| auth.loki.user | object | `{"local":"LOKI_USER","remote":"LOKI_USER"}` | Username for Loki |
| auth.loki.user.local | string | `"LOKI_USER"` | Local Key reference |
| auth.loki.user.remote | string | `"LOKI_USER"` | Remote Key reference |
| auth.mimir | object | `{"password":{"local":"MIMIR_PASSWORD","remote":"MIMIR_PASSWORD"},"user":{"local":"MIMIR_USER","remote":"MIMIR_USER"}}` | Mimir auth configuration |
| auth.mimir.password | object | `{"local":"MIMIR_PASSWORD","remote":"MIMIR_PASSWORD"}` | Password for Mimir |
| auth.mimir.password.local | string | `"MIMIR_PASSWORD"` | Local Key reference |
| auth.mimir.password.remote | string | `"MIMIR_PASSWORD"` | Remote Key reference |
| auth.mimir.user | object | `{"local":"MIMIR_USER","remote":"MIMIR_USER"}` | Username for Mimir |
| auth.mimir.user.local | string | `"MIMIR_USER"` | Local Key reference |
| auth.mimir.user.remote | string | `"MIMIR_USER"` | Remote Key reference |
| auth.secretName | string | `"grafana-cloud-secrets"` | Name of the secret to use for the collector |
| auth.tempo | object | `{"password":{"local":"TEMPO_PASSWORD","remote":"TEMPO_PASSWORD"},"user":{"local":"TEMPO_USER","remote":"TEMPO_USER"}}` | Tempo auth configuration |
| auth.tempo.password | object | `{"local":"TEMPO_PASSWORD","remote":"TEMPO_PASSWORD"}` | Password for Tempo |
| auth.tempo.password.local | string | `"TEMPO_PASSWORD"` | Local Key reference |
| auth.tempo.password.remote | string | `"TEMPO_PASSWORD"` | Remote Key reference |
| auth.tempo.user | object | `{"local":"TEMPO_USER","remote":"TEMPO_USER"}` | Username for Tempo |
| auth.tempo.user.local | string | `"TEMPO_USER"` | Local Key reference |
| auth.tempo.user.remote | string | `"TEMPO_USER"` | Remote Key reference |
...
| k8sattr | object | `{"bind":["otel-collector-kubelet-sa","otel-otlp-collector","otel-otlp-logs-collector","otel-container-logs-collector","otel-collector-k8scluster-sa"],"createRole":true}` | Configuration for k8sattr extension |
| k8sattr.bind | list | `["otel-collector-kubelet-sa","otel-otlp-collector","otel-otlp-logs-collector","otel-container-logs-collector","otel-collector-k8scluster-sa"]` | Service accounts to bind the k8sattr roles to |
